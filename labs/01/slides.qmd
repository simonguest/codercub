...
["Hello World" Notebook](https://jupyter-k12.org?github=simonguest/codercub/blob/main/labs/01/notebooks/hello_world.ipynb){.external target="blank"} on Jupyter-K12
...
Click on this button: <img src="https://img.shields.io/badge/Open_in-Jupyter_K--12-blue" alt="Open In Jupyter K12"/>
...
["AI in Action" Notebook](https://jupyter-k12.org?github=simonguest/codercub/blob/main/labs/01/notebooks/ai_in_action.ipynb){.external target="blank"} on Jupyter-K12
