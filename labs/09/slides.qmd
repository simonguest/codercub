...
# Parking Gate Challenge!

## Parking Gate Challenge!

![](images/parking_detector.jpg){fig-align="center"}

## Parking Gate Challenge

- Write two "license plate" numbers on separate pieces of paper
- Open the Parking Challenge Notebook
- Write the code to use a VLM to read the license plates and open the gate!
